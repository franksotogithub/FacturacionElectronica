...
$services.comprobante.descargarPdf= function (cfnumser,cfnumdoc,tipodoc,callback) {
    var error=false;
    var slug = 'facturacion-api/descargas/descargar-pdf/'+cfnumser+'/'+cfnumdoc+'/'+tipodoc+'/';
    $.ajax({
        type:"GET",
        url: $utils.urlServer(slug),
        dataType:"html",
